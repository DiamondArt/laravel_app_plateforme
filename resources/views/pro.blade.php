				...
				<div class="freelancer">
					...
					<div class="freelancer-overview">
						<div class="freelancer-overview-inner">
							...
							<div class="freelancer-avatar">
								<div class="{{$pros->status}}-badge"></div>
							...
							<div class="freelancer-name">
								...
								<h4><a href="#">{{$pros->lastname}} {{$pros->name}} <img class="flag" src="images/flags/gb.svg" alt="" title="United Kingdom" data-tippy-placement="top"></a></h4>
                                
                                <span>{{$pros->profession}}</span>
								<!-- Rating -->
					...
					<div class="freelancer-details">
						<div class="freelancer-details-list">
							<ul>
								<li>Location <strong><i class="icon-material-outline-location-on"></i> {{$pros->ville}}</strong></li>
								<li>Rate <strong>${{$pros->honoraire}}/ hr</strong></li>
								<li>Job Success <strong>95%</strong></li>
							</ul>
						</div>
						<a href="{{URL::action('ProfileController@show',$pros->id)}}" class="button button-sliding-icon ripple-effect">View Profile <i class="icon-material-outline-arrow-right-alt"></i></a>
					</div>
				</div>
				<!-- Freelancer / End -->
                @endforeach
