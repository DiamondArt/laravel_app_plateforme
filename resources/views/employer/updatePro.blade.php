				...
				<div class="dashboard-nav">
					<div class="dashboard-nav-inner">
						...
						<ul data-submenu-title="Account">
							<li @if(request()->route()->getName() =='employer.index.edit') active @endif><a href="{{route('employer.index')}}"><i class="icon-material-outline-settings"></i> Paramètres</a></li>
										...
										<div class="col-xl-6">
											...
											<div class="submit-field">
												...
												<div class="account-type">
													...
													<div>
														<input type="radio" name="role" value="client" id="employer-radio" class="account-type-radio" checked/>
