        ...
        <div class="left-side">
            ...
            <nav id="navigation">
                ...
                @guest
                    ...
                    <li><a href="browse-companies.html">Categorie</a></li>
                    @else
                    @if(Auth::user()->role=='admin')                    <li><a href="{{route('admin.index')}}">Administration</a></li>
                    <li>
                        <a href="">Gestion des catégories</a>
                    <ul class="dropdown-nav">
								<li><a href="#small-dialog" class="popup-with-zoom-anim button dark ripple-effect">Ajouter</a></li>
                                <li><a href="#smal-dialog" class="popup-with-zoom-anim button dark ripple-effect">Listes</a></li>
                            </ul>
                        </li>
                    @else
                    ...
                    @else
                    <li><a href="{{route('employer.index')}}">Dashboard client</a></li>
                    @endif
                    @endif
                    <li><a href="{{route('pros')}}">Recherche un professionel</a></li>
